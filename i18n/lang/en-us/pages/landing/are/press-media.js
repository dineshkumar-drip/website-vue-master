module.exports = {
  title: 'Invoice Factoring India',
  description:
    'Collateral-free invoice factoring in India. Turn your export invoices into cash. Apply now to get 80% of your invoice value on day one and grow your export business with working capital finance.',
  jumbotron: {
  ...
  statsTitle: 'Quick Facts on Drip Capital',
  stats: [
    {
      number: '$300m+',
      text: 'Trade Financed'
    ...
    {
      number: '40+',
      text: 'Countries with buyers'
    },
    {
      number: '60+',
      text: 'Cities with exporters'
    }
  ],
  features: {
    ...
    benefits: [
      ...
      {
        icon: 'icon2',
        title: 'Credit limit up to $2.5 million',
        description: 'Get post-shipment credit line up to $2.5 million.'
      },
      {
        icon: 'icon3',
