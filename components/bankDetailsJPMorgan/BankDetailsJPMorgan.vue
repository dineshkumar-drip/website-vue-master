  ...
  <b-container class="bank-details-container">
    ...
    <b-row v-else-if="!loading && access" data-aos="fade-right">
      ...
      <b-col :cols="12" :md="8">
        ...
        <b-tabs>
          <b-tab :title="$t('pages.bankDetailsJpm.title')" active>
            <c-usd v-if="currency.jpm_hkg" :currency="currency.jpm_hkg" />
          </b-tab>
        </b-tabs>
      </b-col>
...
import CUsd from '@/components/bankDetailsJPMorgan/Usd'
import qs from 'qs'
