<template>
  <div id="impo-expo-apply-form" class="application-form">
    <b-card id="application-message" class="card-cta shadow border-0 mt-0">
      <slot name="form-title">
        <h4 class="card-title">
          {{ $t('pages.landing.tradeFinance.jumbotron.form.title') }}
        </h4>
      </slot>
      <form @submit.prevent="onSubmit" novalidate>
        ...
        <b-form-group>
          <label class="material-label" :class="{ empty: form.company === '' }">
            ...
            />
            <b-form-invalid-feedback
              >This is a required field requires a valid company
              name.</b-form-invalid-feedback
            >
          </label>
        </b-form-group>
        <b-form-group v-if="!isAe && !isUs && !isEc">
          <label
            class="material-label"
            :class="{ empty: form.products === '' }"
          >
            <span>{{ $t('common.form.placeholders.products') }}</span>
            <b-form-input
            ...
            />
            <b-form-invalid-feedback>
              This is a required field and requires valid products.
            </b-form-invalid-feedback>
          </label>
        </b-form-group>
        <b-form-group v-if="isEc">
          <label
          ...
          >
            ...
            />
            <b-form-invalid-feedback>
              This is a required field and requires a valid category.
            </b-form-invalid-feedback>
          </label>
        </b-form-group>
...
export default {
  ...
  validations() {
    ...
    if (!this.isAe && !this.isUs && !this.isEc) {
      form.products = {
        required,
        safeText
      }
