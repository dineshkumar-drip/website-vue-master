    ...
    <b-row v-else-if="!loading && access" data-aos="fade-right">
      ...
      <b-col :cols="12" :md="8">
        <h3 class="section-title">
          {{ $t('pages.bankDetailsIndia.title') }}
        </h3>
        <b-tabs>
          <b-tab :title="$t('pages.bankDetailsIndia.inr.title')" active>
            <c-inr :currency="currency.axis" />
          </b-tab>
        </b-tabs>
      </b-col>
...
import CInr from '@/components/bankDetailsIndia/Inr'
import qs from 'qs'
